...
export default function PostListItem({ post }: { post: ManifestEntry }) {
  return (
    ...
    >
      <h3 className="text-lg md:text-xl font-medium font-header mb-2 leading-tight text-text-primary">{post.meta_title}</h3>
      <p className="text-sm text-gray-500 font-ui max-w-[800px] leading-relaxed">{post.meta_description}</p>
